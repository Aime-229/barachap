...
<html lang="en">
  <head>
    ...
    <title>Barachap - Le travail à proximité de vous</title>
...
>
  <div class="bb ze ki xn 2xl:ud-px-0 oo wf yf i">
    <div class="vd to/4 tc wf yf">
      <a href="/">
        <img class="om" src="{{ asset('images/bara-chap.png') }}" alt="Logo Light" />
        <img class="xc nm" src="{{ asset('images/bara-chap.png') }}" alt="Logo Dark" />
      </a>
    ...
    >
      <nav>
        <ul class="tc _o sf yo cg ep">
          <li><a href="/" class="xl" :class="{ 'mk': page === 'home' }">Acceuil</a></li>
          <li><a href="/#about" class="xl">A propos</a></li>
          <li><a href="/#support" class="xl">Contact</a></li>
        </ul>
      </nav>
      ...
      <div class="tc wf ig pb no">
        ...
        <a href="{{route('barachap')}}" :class="{ 'hh/[0.15]' : page === 'home', 'sh' : page === 'home' && stickyMenu }" class="lk gh dk rg tc wf xf _l gi hi">S'inscrire</a>
      </div>
    </div>
  </div>
</header>
    ...
    <main>
      ...
      <section class="gj do ir hj sp jr i pg">
        ...
        <div class="xc fn zd/2 2xl:ud-w-187.5 bd 2xl:ud-h-171.5 h q r">
          ...
          <img src="images/bara-hero.png" alt="Woman" class="h q r ua" />
        </div>
        ...
        <div class="bb ze ki xn 2xl:ud-px-0">
          <div class="tc _o">
            <div class="animate_left jn/2">
              <h1 class="fk vj zp or kk wm wb">Trouvez votre prochaine opportunité professionnelle dès maintenant !</h1>
              <p class="fq">
                Inscrivez-vous sur notre plateforme pour être parmi les premiers à découvrir les offres d'emploi correspondant à votre profil. Ne laissez pas passer cette chance de booster votre carrière !
              </p>

              <div class="tc tf yo zf mb">
                <a href="{{route('barachap')}}" class="ek jk lk gh gi hi rg ml il vc _d _l"
        ...
        <div class="bb ze ki yn 2xl:ud-px-12.5">
          <div class="tc uf zo xf ap zf bp mq">
            ...
            <div class="animate_top kn to/3 tc cg oq">
              ...
              <div>
                <h4 class="ek yj go kk wm xb">24/7 Disponible</h4>
                {{-- <p>Disponible 24h/24 et 7j/7 pour vous écouter.</p> --}}
              </div>
            </div>
            ...
            <div class="animate_top kn to/3 tc cg oq">
              ...
              <div>
                <h4 class="ek yj go kk wm xb">Facilité d'utilisation </h4>
            ...
            <div class="animate_top kn to/3 tc cg oq">
              ...
              <div>
                <h4 class="ek yj go kk wm xb">Fiabilité et sécurité</h4>
                {{-- <p>Une équipe disposée à trouver le job pour vous</p> --}}
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="tc wf gg qq">
            ...
            <div class="animate_left xc gn gg jn/2 i">
              <div>
                ...
                <img src="images/menage.jpg" alt="About" style="width: 100%; height:30vh; border-radius: 10px;" />
              </div>
              <div>
            ...
            <div class="animate_right jn/2">
              <h4 class="ek yj mk gb">Pourquoi travailler avec nous ?</h4>
              <h2 class="fk vj zp pr kk wm qb">Nous rendons nos clients heureux en offrant les meilleurs services.</h2>
              <p class="uo">Nous sommes accessibles à tout moment, 24h/24 et 7j/7, afin de vous offrir une variété étendue d'emplois et de candidats. Cette diversité vous assure un vaste choix et augmente vos chances de trouver l'emploi ou le candidat parfaitement adapté à vos besoins.</p>

              <div class="tc tf yo zf mb">
                <a href="{{route('alertes.create')}}" class="ek jk lk gh gi hi rg ml il vc _d _l"
                  >Je veux quelqu'un</a
                >
              </div>
            </div>
      ...
      <section class="lj tp kr">
        <!-- Section Title Start -->
        <div
          x-data="{ sectionTitle: `Comment ça marche ?`, sectionTitleText: `Nous vous offrons la meilleure qualité de service`}"
        >
  ...
  <div class="bb ze ki xn 2xl:ud-px-0">
    ...
    <div class="text-center">
      <div class="animate_top">
        <p>&copy; 2025 Yabara. Tous droits réservés | réalisé par Aimé LINGUE</p>
      </div>
    </div>
    <!-- Footer Bottom -->
  </div>
