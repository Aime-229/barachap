<x-guest-layout>
    <form class="w-full" action="{{ route('barachap') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    value="{{ old('nom') }}" name="nom" id="grid-city" type="text" placeholder="Jane">
                <div>
                    @error('nom')
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    value="{{ old('prenom') }}" name="prenom" id="grid-last-name" type="text" placeholder="Doe">
                <div>
                    @error('prenom')
                        <div class="invalid-feedback text-red-500">{{ $message }}</div>
                    @enderror
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-city" value="{{ old('datenaissance') }}" name="datenaissance" type="date">
                <div>
                    @error('datenaissance')
                        <div class="invalid-feedback text-red-500">{{ $message }}</div>
                    @enderror
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            ...
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-zip" value="{{ old('numero') }}" name="numero" type="text" placeholder="0544757216">
                <div>
                    @error('numero')
                        <div class="invalid-feedback text-red-500">{{ $message }}</div>
                    @enderror
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-last-name" value="{{ old('personneacontacter') }}" name="personneacontacter"
            ...
            <div class="w-full md:w-1/2 px-3">
                ...
                <input
                    ...
                    id="grid-last-name" value="{{ old('numeropersonne') }}" name="numeropersonne" type="text"
                    placeholder="90210">
                <div>
